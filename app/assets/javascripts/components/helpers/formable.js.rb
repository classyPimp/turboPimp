module Helpers
	module Formable
		...
		def self.included(base)
			raise "#{self} should be included to RW class only" unless base.is_a? RW
		end
		...
		def input(model, attr, options = {}, *_children)
			...
			#type => React element which will be used as input handler for attr
